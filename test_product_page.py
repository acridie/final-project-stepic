...
class TestUserAddToBasketFromProductPage:
    ...
    def setup(self, browser):
        email = Person().email(['@fakemail.org'], True)
        passwrd = Person().password(9)
        link = "http://selenium1py.pythonanywhere.com/ru/accounts/login"
        self.page = LoginPage(browser, link)
        self.page.open()
        self.page.register_new_user(email, passwrd)
    ...
    @pytest.mark.xfail(reason="Because of tests with alerts")
